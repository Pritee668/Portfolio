...
// import { SiTailwindcss, SiBootstrap, SiSass, SiExpress, SiEjs, SiSqlite, SiMysql, SiMongodb, SiC, SiCplusplus } from 'react-icons/si';
// import { FaPython, FaPhp, FaNodeJs, FaGitAlt, FaGithub, FaWordpress, FaHtml5, FaCss3Alt, FaJs, FaReact, FaDatabase } from 'react-icons/fa';
...
//         <div key={categoryIndex} className="skills-category" style={{ width: '40%',height:'auto', margin: '1rem auto' }}>
...
//               
                        //<Card sx={{ maxWidth: 120, margin: 'auto', backgroundColor: '#f5f5f5' }}>
