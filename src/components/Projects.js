...
const core = [
  ...
  },
  {
    ...
    description: 'A web-based application that converts text into speech and transcribes speech into text using AI-powered speech recognition and synthesis.',
    link: 'https://real-time-tts-tts.netlify.app/',  
    github: 'https://github.com/Pritee668/real-time-stt-tts-react', 
    tech: ['JavaScript', 'HTML', 'CSS', 'React', 'Web Speech API', 'Bootstrap'],
    image: TextSpeechImage  
}
];
