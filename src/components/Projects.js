...
const core = [
  ...
  },
  {
    ...
    description:'A React app using Web Speech API and Gemini AI for real-time speech-to-text and text-to-speech with dynamic dialogue management',
    link: 'https://real-time-tts-tts.netlify.app/',
    github: 'https://github.com/Pritee668/real-time-stt-tts-react',
    tech: ['JavaScript', 'HTML', 'CSS', 'React', 'Gemini API', 'Boostrap'],
    image: TTS,
  }
];
